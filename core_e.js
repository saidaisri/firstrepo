...
app.directive('sriDirective', function($filter){
	return {
	  restrict: 'EA',
	  template : '<table border="1">\
		<tr><th><button ng-click="sortBy(\'first_name\')">First Name</button><span class="sortorder" ng-show="propertyName === \'first_name\'" ng-class="{reverse: reverse}">\
		</span></th>\
		<th><button ng-click="sortBy(\'last_name\')">Last Name</button><span class="sortorder" ng-show="propertyName === \'scope.user.last_name\'" ng-class="{reverse: reverse}">\
		</span></th>\
		<th><button ng-click="sortBy(\'e_id\')">Employee ID</button><span class="sortorder" ng-show="propertyName === \'e_id\'" ng-class="{reverse: reverse}"></span>\
		</th>\
		<th><button ng-click="sortBy(\'e_mail\')">E Mail</button><span class="sortorder" ng-show="propertyName === \'e_mail\'" ng-class="{reverse: reverse}">\
		</span></th>\
		<th><button ng-click="sortBy(\'pass\')">Pass</button><span class="sortorder" ng-show="propertyName === \'pass\'" ng-class="{reverse: reverse}">\
		</span></th>\
		<th><button ng-click="sortBy(\'phone\')">Phone</button><span class="sortorder" ng-show="propertyName === \'phone\'" ng-class="{reverse: reverse}">\
		</span></th>\
		<th><button ng-click="sortBy(\'address\')">Address</button><span class="sortorder" ng-show="propertyName === \'address\'" ng-class="{reverse: reverse}">\
		</span></th>\
		<th><button ng-click="sortBy(\'country\')">Country</button><span class="sortorder" ng-show="propertyName === \'country\'" ng-class="{reverse: reverse}">\
		</span></th>\
		<th><button ng-click="sortBy(\'state\')">State</button><span class="sortorder" ng-show="propertyName === \'state\'" ng-class="{reverse: reverse}">\
		</span></th>\
		<th><button ng-click="sortBy(\'city\')">City</button><span class="sortorder" ng-show="propertyName === \'city\'" ng-class="{reverse: reverse}">\
		</span></th>\
		<th><button ng-click="sortBy(\'pin_code\')">Pin Code</button><span class="sortorder" ng-show="propertyName === \'pin_code\'" ng-class="{reverse: reverse}">\
		</span></th>\
		<th><button ng-click="sortBy(\'gender\')">Gender</button><span class="sortorder" ng-show="propertyName === \'gender\'" ng-class="{reverse: reverse}">\
		</span></th></tr>\
		<tr ng-repeat="user in usersd | orderBy:propertyName:reverse">\
			<td> {{ user.first_name }} </td><td> {{ user.last_name }} </td><td> {{ user.e_id }} </td><td> {{ user.e_mail }} </td><td> {{ user.pass }} </td>\
			<td> {{ user.phone }} </td><td> {{ user.address }} </td><td> {{ user.country }} </td><td> {{ user.state }} </td><td> {{ user.city }} </td>\
			<td> {{ user.pin_code }} </td><td> {{ user.gender }} </td><td> <a href="edit.html#/?email={{ user.e_mail }}"> Edit </a> </td>\
	  ...
	  link: function (scope) {
			scope.sortBy = function(propertyName) {
			  console.log('45 '+scope.propertyName);
